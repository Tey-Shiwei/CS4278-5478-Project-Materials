...
class Runner:
    def __init__(self, agent, ix, train = True, **kwargs):
        ...
        self.env = env = DuckietownEnv(map_name = MAP, domain_rand = False, draw_bbox = False,max_steps = 1500,seed = SEED)
...
class Trainer:
    def __init__(self, gamma, agent, window = 15, workers = 1, **kwargs):
